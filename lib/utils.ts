...
//         const priceTextTrim = priceText.substring(
//           0,
//           priceText.indexOf(".") + 3
//         );
//         return priceTextTrim.trim();
//       } else {
//         const priceTextTrim = priceText;
//         return priceTextTrim.trim();
//       }
//     }
//   }
...
export function getCategory(title: string) {
    if (title.toLowerCase().includes("shoes")) {
      return "Shoes";
    } else if (title.toLowerCase().includes("clothing")) {
      return "Clothing";
    } else if (title.toLowerCase().includes("accessories")) {
      return "Accessories";
      ...
      return "Watch";
        ...
        title.toLowerCase().includes("home appliances")
    ) {
      return "Furniture";
    } else {
      return "Other";
